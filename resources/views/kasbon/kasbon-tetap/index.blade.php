      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
                <table id="kasbonTetap" class="table table-bordered table-striped">
                  <thead>
                  <tr>
                    <th>Nomor</th>
                    <th>Nama Pegawai</th>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Tambah Kasbon Pegawai Tetap</h4>
          ...
          <div class="modal-body">
            <form action="{{ url('/kasbon-tetap/create') }}" method="POST">
              @csrf
              <div class="form-group">
                <label>Nama Pegawai</label>
                <select class="form-control" name='id_pgw_normal' id="nama">
                  <option value="">~ Pilih ~</option>
                  @foreach ($data as $item)
                    @if (old('id_pgw_normal') == $item->id)
...
<script>
    $(document).ready(function(){
        $('#kasbonTetap').DataTable({
            "responsive": true, 
            "autoWidth": false,
            "processing": true,
            "serverside": true,
            "ajax": "{{ url('dataTable/KasbonTetap') }}",
            "columns": [{
                data: 'DT_RowIndex',
                name: 'DT_RowIndex',
                orderable: false,
