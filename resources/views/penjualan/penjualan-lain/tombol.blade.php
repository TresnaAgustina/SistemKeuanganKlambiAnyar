...
<a href="/penjualan-lain/detail/{{ $data->kode_penjualan }}" data-id="{{ $data->id }}" class="btn btn-warning btn-sm view" style="float: left; margin-left: 5px; "> <i class="fas fa-eye"></i></a>
