          ...
          <div class="card-header" style=" border-bottom: none;">
            <div class="row">
              <div class="col-md-9">
                ...
                <p><strong>Metode Pembayaran : {{ $data->metode_pembayaran }} </strong></p>  
              </div>
              <div class="col-md-3">
                ...
                @else
                <p><strong>Total Penjualan : Rp. {{ number_format($credit) }}</strong></p>
                <p><strong> Jatuh Tempo : {{ date('d-m-Y', strtotime( $data->tgl_jatuh_tempo )) }} </strong></p>
                @endif
              </div>
            </div>
          </div>
